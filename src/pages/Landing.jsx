...
const Landing = () => {
  return (
    ...
    <div className=" col-span-full m768:col-span-1 flex flex-col h-screen justify-center">
      ...
      <p className="text-justify text-xl my-8 mx-4">I build dynamic, responsive web apps using Wordpress,PHP, MongoDB, Express.js, React.js, and Node.js. Check out my projects to see my work in action.</p>
      <Social />
    </div>
    </div>
  )
