...
const Landing = () => {
  return (
    ...
    <div className=" col-span-full m768:col-span-3 flex flex-col h-auto m768:h-screen justify-center items-center m768:items-start mt-4 m768:mt-0">
    ...
    <div className="col-span-full order-first m768:col-span-2 m768:order-last">
      <img src={LandingImage} alt="Landing" className=" w-2/3 h-2/3 mt-[15vh] m768:mt-0 mx-auto m768:w-full m768:h-full object-cover" />
    </div>
