...
const Social = () => {
  ...
  const socialLinks = [
    {
      url: "https://www.linkedin.com/in/avijitkarmaker/",
      icon: (
        <svg
          fill="white"
          width="15px"
    ...
    {
      url: "https://github.com/ajkacca457",
      icon: (
        <svg
          width="15px"
          height="15px"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            {" "}
            <title>github [#ababab]</title> <desc>Created with Sketch.</desc>{" "}
            <defs> </defs>{" "}
            <g
              id="Page-1"
              stroke="none"
    ...
    {
      url: "https://www.instagram.com/darklightfiction",
      icon: (
        <svg
          width="15px"
          height="15px"
  ...
  return (
    <div className="flex items-center gap-4 my-8 mx-4">
      <button class="relative inline-block p-px font-semibold leading-6 text-white no-underline bg-gray-800 shadow-2xl cursor-pointer group rounded-xl shadow-zinc-900">
        ...
        <div class="relative z-10 flex items-center px-4 py-2 space-x-2 rounded-xl bg-gray-950/50 ring-1 ring-white/10 ">
