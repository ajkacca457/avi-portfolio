...
const AboutMe = () => {
  return (
    <div className="h-[75v] m768:h-[65vh] bg-slate-800 col-span-full m768:col-span-4 rounded border-[1px] border-green-700 overflow-y-scroll custom-scrollbar mx-4 pb-4">
      <p className="p-4 text-sm m768:text-lg text-justify">
      ...
      <p className="px-4 text-sm m768:text-lg">I am a Full Stack Developer proficient in:</p>

        <ul className="px-4 text-sm m768:text-lg">
        ...
        <p className="px-4 mt-2 text-sm m768:text-lg text-justify">
        ...
        <p className="px-4 text-sm m768:text-lg text-justify">
