...
const AboutMe = () => {
  return (
    <div className="h-[60vh] bg-slate-800 col-span-2 rounded border-[1px] border-purple-700 overflow-y-scroll custom-scrollbar">
      <p className="p-4">
      ...
      <p className="px-4">I am a Full Stack Developer proficient in:</p>
        ...
        <ul className="px-4">
            <li> <span className="text-purple-500 font-bold block">Languages:</span> JavaScript (ES6), Python, Ruby, PHP, HTML5, CSS3</li>
            <li><span className="text-purple-500 font-bold block">Frameworks:</span> Ruby on Rails, ReactJS, jQuery, Tailwind, Bootstrap, Scss, Vue.js, Node.js</li>
            <li><span className="text-purple-500 font-bold block">Databases:</span> MySQL, PostgreSQL, SQLite</li>
            <li><span className="text-purple-500 font-bold block">Concepts:</span> Data Structures & Algorithms, Git,Pair Programming, Heroku, OOP/OOD, API Development, MVC</li>
            <li><span className="text-purple-500 font-bold block">Graphics:</span> Photoshop, Illustrator, After Effects, Premiere Pro, Sketch</li>  
        </ul>
