...
const About = () => {
  ...
  return (
    <div className='px-3 py-1' ref={scope}>
        ...
        <p className='text-slate-400 opacity-0 my-3 text-justify text-body'>I am excited to be a part of new endeavors and eager to make a difference in the world through my work. <span className='text-white'>Let's connect and explore the possibilities together!</span></p>
    </div>
  )
}
