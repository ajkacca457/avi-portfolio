...
const About = () => {
  return (
    <div>
        ...
        <p className='text-slate-400 my-3'> I am excited to collaborate with driven and innovative teams to build something meaningful that will have a positive impact on society. I am confident that my blend of technical proficiency, creativity, and dedication will contribute to the success of any project I undertake</p>
        <p className='text-slate-400 my-3'>I am excited to be a part of new endeavors and eager to make a difference in the world through my work. Let's connect and explore the possibilities together!</p>
    </div>
  )
}
