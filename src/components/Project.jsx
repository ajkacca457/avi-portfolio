  ...
  return (
    <div className="my-4 grid grid-cols-5 gap-x-6 py-2 group items-center z-0 h-full relative">
      ...
      <div className="col-span-full m540:col-span-2">
        <p className=" text-6xl font-extrabold bg-gradient-to-r from-emerald-500 via-emerald-700 to-emerald-500 inline-block text-transparent bg-clip-text">
          {id}
        </p>
        <Link
          to={url}
        ...
        >
          <p className="text-subheading my-4">{title}</p>
          <svg
            className="ml-1 my-4"
            width="20px"
            height="20px"
        ...
        <div className="flex flex-wrap my-4">
          {stack.map((item, index) => (
            <div class="mr-2 mb-2 bg-gradient-to-b from-emerald-800 to-emerald-900 rounded-lg px-2 py-1 text-white transition duration-150 text-xs hover:bg-green-700">
              {item}
            </div>
          ))}
        </div>
