...
const Form = () => {
  return (
    <div class="w-full p-8 bg-purple-900 rounded-md shadow-md form-container">
    ...
    <form action="https://fabform.io/f/insert-form-id" method="POST">
      ...
      <div class="mb-6">
        ...
        <textarea id="message" name="message" rows="4" placeholder="How can we help you?" required
          class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-purple-500 bg-purple-700 text-white"></textarea>
      </div>
      <button type="submit"
        class="bg-slate-800 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue">
        Submit
      </button>
    </form>
  </div>
