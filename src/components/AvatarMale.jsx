...
export function AvatarMale(props) {
  ...
  const {animations:armGesture} = useFBX('/animations/ArmGesture.fbx');
  ...
  useEffect(() => {
    actions['ArmGesture'].clampWhenFinished = true;
...
useGLTF.preload('/models/663dcdb0515d91cf7828578a.glb')