...
const ProjectPage = () => {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between overflow-x-hidden bg-black text-white">
      <Link href='/' className='fixed left-10 top-[20px] z-50 bg-blue-900 px-4 py-2 rounded-md text-sm md:text-base border-[1px] border-white transition-all duration-200 hover:bg-blue-700'>Back to home</Link>
