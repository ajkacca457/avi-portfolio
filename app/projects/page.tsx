...
const ProjectPage = () => {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between overflow-x-hidden bg-black text-white">
      <Link href='/' className='fixed left-10 top-[20px] z-50 bg-gradient-to-b from-slate-800 via-slate-950 to-slate-800 px-4 py-2 rounded-full text-sm border-[1px] border-blue-300 transition-all duration-300 hover:bg-gradient-to-l hover:from-blue-900 hover:via-blue-950 hover:to-blue-900'>Back to home</Link>
