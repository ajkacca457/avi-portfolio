...
export default function Experience() {
  return (
    <section id="experience" className="border-b border-vsc-border-light">
        ...
        <div className="flex flex-col">
          {experiences.map((exp, index) => (
            <FadeIn key={index} delay={index * 0.1} direction="left">
              <div className="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-2 md:gap-6 py-6 border-b border-vsc-border-light last:border-b-0">
