...
const Social = () => {
    return (
        <article>
            <h1 className="text-xl md:text-3xl font-semibold text-purple-300">Lets Talk</h1>
            ...
            <div className="mt-6">
                <h2 className="text-sm md:text-lg text-purple-300">Email</h2>
                <ul className="mt-3">
                    <li className="flex items-center">
                        ...
                        <a href="mailto:ajkacca@gmail.com" className="text-purple-300 text-sm md:text-base ml-3">
            ...
            <div className="mt-6">
                <h2 className="text-sm md:text-lg text-purple-300">Phone</h2>
                <ul className="mt-3">
                    <li className="flex items-center">
                        <div className="group bg-gradient-to-r from-indigo-500 to-blue-800 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <MdPhoneInTalk size={20} className='text-white drop-shadow-md transition duration-300 group-hover:scale-125' />
                        </div>
                        <a href="tel:+358465201355" className="text-purple-300 text-sm md:text-base ml-3">
            ...
            <div className="mt-12">
                <h2 className="text-sm md:text-lg text-purple-300">Socials</h2>
